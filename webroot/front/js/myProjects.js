$(document).ready(function () {
    ...
    $('.delete-project').on('click', function () {
        console.log('a');
        $('#deleteProject-' + $(this).data('project')).modal('show');
    });

    $('.open-anexo').click(function () {
        var modal = $('#project-file-' + $(this).data('project'));

        modal.modal('show');
        modal.find('.text-delete-project').focus();
    });

    $('.text-delete-project').on('keyup', function () {
        var project = $(this).data('project');

        if (removeDiacritics($(this).val().toLowerCase()) == 'eu entendo as consequencias, deletar este projeto') {
            $('#deleteProjectBtn-' + project).attr('disabled', false);
        } else {
            $('#deleteProjectBtn-' + project).attr('disabled', true);
        }
    });

    $('.deleteProject').on('click', function () {
        var url = webroot + 'projects/delete-project';
        var data = {
            project_id: $(this).data('project')
        };
